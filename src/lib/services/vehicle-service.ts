...
const VEHICLES_API_URL = `${API_BASE_URL}/apis/marketplace/vehicles`;
const BANNERS_API_URL = `${API_BASE_URL}/apis/marketplace/banners`;
...
const constructImageUrl = (path?: string) => {
  ...
  return `${API_BASE_URL}/apis${separator}${path}`;
}
